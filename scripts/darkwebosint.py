import argparse
from scripts.tor_control import start_tor_service, stop_tor_service
...
def main():
    ...
    # Start Tor before running tools
    start_tor_service()
    ...
    try:
        ...
        # Stop Tor after all execution (even if error occurs)
        stop_tor_service()
